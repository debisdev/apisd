...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CodMetmed).HasName("mat_med_pkey");

            entity.ToTable("mat_med");

            entity.HasIndex(e => e.CodMetmed, "idx_cod_matmed");

            entity.Property(e => e.CodMetmed).HasColumnName("cod_metmed");
            entity.Property(e => e.CodClasse).HasColumnName("cod_classe");
            entity.Property(e => e.CodFab).HasColumnName("cod_fab");
        ...
        modelBuilder.Entity<Medico>(entity =>
        {
            ...
            entity.HasIndex(e => e.CodMedico, "id_cod_medico");
        ...
        modelBuilder.Entity<Paciente>(entity =>
        {
            ...
            entity.HasIndex(e => e.Cpf, "idxd_cpf");
